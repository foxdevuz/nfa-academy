<nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-4 py-lg-0 px-3 px-lg-0">
    ...
    <div class="navbar-nav ms-auto mx-lg-auto py-0">
        ...
        <div class="nav-item dropdown">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Raxbariyat</a>
       ...
       <div class="flex">
        ...
        <a target="_blank" href="https://instagram.com/namangan_football_academy"><i class="ufaImagey fa-brands fa-instagram"></i></a>
