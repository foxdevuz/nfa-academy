<x-admin.index-layout>
    <form action="/admin/storeCoach/u-16" method="post" enctype="multipart/form-data">
        @csrf
        <p class="text-center">U16 klubi uchun boshqaruv | Murabbiy qo'shish</p>
    ...
    {{-- adding club members --}}
    <form action="/admin/storeStudents/u-16" method="post" enctype="multipart/form-data" class="mt-5">
        @csrf
        <p class="text-center mt-5">U16 klubi uchun boshqaruv | O'quvchi qo'shish</p>
