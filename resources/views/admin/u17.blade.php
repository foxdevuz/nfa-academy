<x-admin.index-layout>
    <form action="/admin/storeCoach/u-17" method="post" enctype="multipart/form-data">
        @csrf
        <p class="text-center">U17 klubi uchun boshqaruv | Murabbiy qo'shish</p>
    ...
    {{-- adding club members --}}
    <form action="/admin/storeStudents/u-17" method="post" enctype="multipart/form-data" class="mt-5">
        @csrf
        <p class="text-center mt-5">U17 klubi uchun boshqaruv | O'quvchi qo'shish</p>
