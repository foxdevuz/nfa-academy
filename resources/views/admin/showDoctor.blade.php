    ...
    @foreach ($doctor as $item)
        <div class="card" style="width: 19rem; display:inline-block; margin: 0 1.2rem 1rem 1.2rem;">
            ...
            <div class="card-body">
                ...
                <a href="/doctors/delete?id={{ $item->id }}" class="btn btn-danger rounded">O'chirib tashlash</a>
                <a href="/admin/doctors/{{ $item->id }}" class="btn btn-warning rounded">Tahrirlash</a>
            </div>
        </div>
    @endforeach
</x-admin.index-layout>
