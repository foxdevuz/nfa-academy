<x-admin.index-layout>
    ...
    {{-- adding club members --}}
    <form action="/admin/storeStudents/u-15" method="post" enctype="multipart/form-data" class="mt-5">
        @csrf
        <p class="text-center mt-5">U15 klubi uchun boshqaruv | O'quvchi qo'shish</p>
