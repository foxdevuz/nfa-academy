<x-admin.index-layout>
    <form action="/admin/storeCoach/u-18" method="post" enctype="multipart/form-data">
        @csrf
        <p class="text-center">U18 klubi uchun boshqaruv | Murabbiy qo'shish</p>
        ...
        <button type="submit" class="btn btn-primary rounded mt-5">Joylash</button>
    </form>

    {{-- adding club members --}}
    <form action="/admin/storeStudents/u-18" method="post" enctype="multipart/form-data" class="mt-5">
        @csrf
        <p class="text-center mt-5">U18 klubi uchun boshqaruv | O'quvchi qo'shish</p>
